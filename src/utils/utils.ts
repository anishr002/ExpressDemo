...
import engMessage from '../messages/english.json';
import {
  AuthMessages,
  AdminMessages,
  UserMessages,
...
interface EngMessages {
  ...
  admin: AdminMessages;
  user: UserMessages;
  emailTemplate: EmailTemplateMessages;
  default: DefaultMessages;
}

//decalre type of message
const messages: EngMessages = engMessage;

//return message for user
// Return message for user
export const returnMessage = <M extends keyof EngMessages>(
  module: M,
  key: keyof EngMessages[M],
): string | undefined => {
  const message = messages[module][key];
  return typeof message === 'string' ? message : undefined;
};

//reolace filed
exports.replaceFields = (inputString: any, replacements: any) => {
...
exports.capitalizeFirstLetter = (string: any) => {
  return string?.charAt(0).toUpperCase() + string?.slice(1);
};

exports.validateRequestFields = (payload: any, fields: any) => {
...
//   `;
// };
export const verifyUser = (link: any, username: any) => {
  return `
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html
  xmlns="http://www.w3.org/1999/xhtml"
...
exports.paginationObject = (paginationObject: any) => {
  const page = paginationObject.page || 1;
